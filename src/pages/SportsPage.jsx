...
const SportsPage = () => {
  ...
  useEffect(() => {
    const loadProducts = async () => {
      try {
        setLoading(true);
        const products = await generateCategoryProducts('Sports', 200);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading sports products...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">Gear up for your active lifestyle with our sports collection</p>
