...
const FashionPage = () => {
  ...
  useEffect(() => {
    const loadProducts = async () => {
      try {
        setLoading(true);
        const products = await generateCategoryProducts('Fashion', 200);
  ...
  const currentProducts = filteredProducts.slice(0, endIndex); // Show all products up to current page
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">Discover the latest trends in fashion and style</p>
        ...
        <div className="flex justify-center gap-4">
          ...
          {currentPage < totalPages && (
            <motion.button
              ...
              className="flex items-center gap-2 px-8 py-3 bg-pink-600 text-white rounded-lg hover:bg-pink-700 transition-colors font-medium"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              Load More Products
