  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/_evil07_/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-500">Customer Service</h3>
            <ul className="space-y-2">
              <li>
          ...
          {/* Contact Info - Updated with new details */}
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">+91 91428 70825</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-gray-400" />
                <span className="text-gray-400">kp198237@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Bottom Bar - Updated with working links */}
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 EcoStore. All rights reserved. Made with ❤️ by Prince
          </p>
